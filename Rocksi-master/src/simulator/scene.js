...
import kukaIIWA14 from './robots/kuka_iiwa14';
import husky from './robots/husky';

let robotMap = {
  franka,
  niryo,
  sawyer,
  'kuka%20iiwa14': kukaIIWA14,  // URL编码版本 (空格->%20)
  'kukaiiwa14': kukaIIWA14,     // 无空格版本
  'kuka iiwa14': kukaIIWA14,    // 直接空格版本
  'kuka_iiwa14': kukaIIWA14,    // 下划线版本
  'kuka-iiwa14': kukaIIWA14,    // 连字符版本
  'iiwa14': kukaIIWA14,         // 简短版本
  'clearpath%20husky': husky,   // URL编码版本 (空格->%20)
  'clearpathhusky': husky,      // 无空格版本
  'clearpath husky': husky,     // 直接空格版本
  'clearpath_husky': husky,     // 下划线版本
  'clearpath-husky': husky,     // 连字符版本
  'husky': husky,               // 简短版本
};
